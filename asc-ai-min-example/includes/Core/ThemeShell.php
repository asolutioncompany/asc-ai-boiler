<?php
/**
 * Minimum example product hooks for boiler ThemeShell (header/footer/CTA partials).
 *
...
use ASC\AI_MIN_EXAMPLE\Front\CallToAction;
use ASC\AI_MIN_EXAMPLE\Front\SiteFront;

/**
 * Supplies minimum example partial markup to the boiler theme shell.
 */
final class ThemeShell {
	...
	public static function filter_main_class( string $main_class ): string {
		return 'asc-ai-boiler-main min-example-main';
	}
}
