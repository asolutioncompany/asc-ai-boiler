...
/**
 * CTA shortcode handlers (content from partial; {@see ExamplePartialCatalog::KEY_CONTACT_CALL_TO_ACTION}).
 */
class CallToAction {
	...
	public function render_cta_shortcode(): string {
		$markup = PartialStore::get_raw_markup( ExamplePartialCatalog::KEY_CONTACT_CALL_TO_ACTION );
		if ( '' === trim( $markup ) ) {
			return '';
		}
