...
/**
	...
	/**
	 * Plugin content directory absolute path (`content/` under the plugin root, trailing slash).
	 */
	public static function get_content_directory(): string {
		return trailingslashit( plugin_dir_path( \ASC_AI_BOILER_PLUGIN_FILE ) . trim( SyncConfig::CONTENT_RELATIVE_ROOT, '/' ) );
	}
