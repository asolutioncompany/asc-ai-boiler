...
final class ContentMediaSync {
	...
	/**
	 * @return string Absolute path to content/media/.
	 */
	public static function get_media_directory(): string {
		return Core::get_instance()->get_plugin_path() . self::MEDIA_RELATIVE_DIR;
	}
	...
	public static function get_media_url( string $relative_path ): string {
		...
		return esc_url(
			Core::get_instance()->get_plugin_url() . self::MEDIA_RELATIVE_DIR . $relative_path
		);
	}
	...
	public static function get_content_manifest_path(): string {
		return Core::get_instance()->get_plugin_path() . 'content/content-manifest.json';
	}
