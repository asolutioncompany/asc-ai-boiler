		...
		$localized = array(
			...
			'sync' => array(
				...
				'strings' => array(
					...
					'export_complete_with_meta' => __( 'Export finished. Wrote %1$s HTML file(s) and updated content-manifest.json; metadata refreshed for %2$s post(s).', \ASC_AI_PLUGIN_DOMAIN ),
